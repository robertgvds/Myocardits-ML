# TREINAMENTO USANDO A CNN-KCL E COM DADOS EM ARRAYS 
...
RESULTS_PATH = f'C:/Users/rober/Documents/MyocarditisML/TREINAMENTOS-ARRAY/CNN-KCL/{DATASET_TYPE}/'
...
path = RESULTS_PATH + f'/{DATASET_TYPE}-resultados_cnn-kcl.txt'
...
f1=open(path,'w')
f1.write(f'TREINAMENTO USANDO A CNN-KCL E COM DADOS EM ARRAYS E DATASET {DATASET_TYPE}\n')
