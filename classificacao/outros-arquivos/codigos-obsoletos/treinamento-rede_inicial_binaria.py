# TREINAMENTO USANDO A REDE INICIAL BINARIA E COM DADOS EM ARRAYS 
...
RESULTS_PATH = f'C:/Users/rober/Documents/MyocarditisML/TREINAMENTOS-ARRAY/REDE-INICIAL-BINARIA/{DATASET_TYPE}/'
...
path = RESULTS_PATH + f'/{DATASET_TYPE}-resultados_rede-incial-binaria.txt'
...
f1=open(path,'w')
f1.write(f'TREINAMENTO USANDO A REDE INICIAL BINARIA E COM DADOS EM ARRAYS E DATASET {DATASET_TYPE}\n')
